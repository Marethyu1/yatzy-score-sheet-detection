...
img_path = './assets/sample_sheets/tiwhole3.png'
...
cv_utils.show_window('img_yatzy_cells', img_yatzy_cells, debug=True)
cv_utils.show_window('img_binary_yatzy_sheet', img_binary_yatzy_sheet, debug=True)
cv_utils.show_window('img_binary_only_numbers', img_binary_only_numbers, debug=True)
print("nice")
...
for i, cnt in enumerate(digit_contours):
    ...
    yatzy_cell = ocr_sheet.validate_and_find_yatzy_cell(yatzy_cells_bounding_rects, digit_bounding_rect)
